...
export const dom = {
  ...
  overlayBlurInput: document.getElementById('overlayBlurInput'),
  shadowOffsetXInput: document.getElementById('shadowOffsetXInput'),
  shadowOffsetYInput: document.getElementById('shadowOffsetYInput'),
  ...
  outlinePositionSelect: document.getElementById('outlinePositionSelect'),
  ...
  iconOverlayTypeSelect: document.getElementById('iconOverlayTypeSelect'),
  iconOverlayOpacityInput: document.getElementById('iconOverlayOpacityInput'),
  iconOverlayBlurInput: document.getElementById('iconOverlayBlurInput'),
  iconShadowOffsetXInput: document.getElementById('iconShadowOffsetXInput'),
  iconShadowOffsetYInput: document.getElementById('iconShadowOffsetYInput'),
  iconOutlineCheckbox: document.getElementById('iconOutlineCheckbox'),
  iconOutlineWidthInput: document.getElementById('iconOutlineWidthInput'),
  iconOutlinePositionSelect: document.getElementById('iconOutlinePositionSelect'),
  iconOutlineColorInput: document.getElementById('iconOutlineColorInput'),
